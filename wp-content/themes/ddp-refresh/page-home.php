...
/*
	...
	foreach( $slides as $slide ) {
		...
		$sOut .= '<h2 class="headline headline--carousel">'.get_the_title($slide->ID ).'</h2>';
...
?>
	...
	<ul class="carousel carousel--landing">
		<li class="carousel__slide" style="background-image: url('http://placehold.it/2500x1238');">
			<div class="carousel__slide__content">
				<h2 class="headline headline--carousel">Explore Downtown Parks</h2>
		...
		<li class="carousel__slide" style="background-image: url('http://placehold.it/2500x1238');">
			<div class="carousel__slide__content">
				<h2 class="headline headline--carousel">News Headline That is Really long making it wrap into two lines</h2>
		...
		<li class="carousel__slide" style="background-image: url('http://placehold.it/2500x1238');">
			<div class="carousel__slide__content">
				<h2 class="headline headline--carousel">Promotion Headline</h2>
