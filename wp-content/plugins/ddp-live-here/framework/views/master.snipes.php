      ...
      <div class="filter-content columned js-live-here-filters">
        <div class="columned-row">
          <div class="housing-type">
            ...
            <div class="checkbox-list">
              <div class="checkbox-group">
                <input type="checkbox" name="ddp-filter-rent" value="rent" class="js-ddp-live-trigger-update js-ddp-live-filter-value" checked="checked">
              ...
              <div class="checkbox-group">
                <input type="checkbox" name="ddp-filter-buy" value="buy" class="js-ddp-live-trigger-update js-ddp-live-filter-value" checked="checked">
          ...
          <div class="rental-price-range">
            <div class="range-group js-range-group monetary">
              ...
              <input type="hidden" class="js-ddp-live-filter-value js-min-value slider-value" value="0" />
              <input type="hidden" class="js-ddp-live-filter-value js-max-value slider-value max-value" value="500" />
        ...
        <div class="columned-row">
          <div class="bedrooms">
            <div class="button-group">
              ...
              <button type="button" data-ddp-live-button-value="studio" class="js-ddp-live-trigger-update js-ddp-live-filter-value selected">Studio</button>
              <button type="button" data-ddp-live-button-value="1" class="js-ddp-live-trigger-update js-ddp-live-filter-value selected">1</button>
              <button type="button" data-ddp-live-button-value="2" class="js-ddp-live-trigger-update js-ddp-live-filter-value selected">2</button>
              <button type="button" data-ddp-live-button-value="3" class="js-ddp-live-trigger-update js-ddp-live-filter-value selected">3</button>
              <button type="button" data-ddp-live-button-value="4" class="js-ddp-live-trigger-update js-ddp-live-filter-value selected">4</button>
              <button type="button"  data-ddp-live-button-value="5" class="js-ddp-live-trigger-update js-ddp-live-filter-value selected">5</button>
              <button type="button" data-ddp-live-button-value=""6 class="js-ddp-live-trigger-update js-ddp-live-filter-value selected">6+</button>
            </div>
          </div>
        ...
        <div class="columned-row">
          <div class="listing-toggle-button">
            <button class="action-button" type="button"><span class="js-toggle-label">Show</span> Listings</button>
          </div>
...
<!-- END FILTER FORM -->
      <button class="toggle-button toggle-content-display js-toggle-content-display" type="button">
