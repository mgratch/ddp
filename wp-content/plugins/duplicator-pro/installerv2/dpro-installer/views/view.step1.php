...
/* @var $archive_config DUPX_Archive_Config */
$archive_config = DUPX_Archive_Config::get_instance();

$should_display_multisite = ($archive_config->mu_mode !== 0) && (count($archive_config->subsites) > 0) && $archive_config->debug_mode;

// RSR Change this back later
// $multisite_disabled = ($archive_config->get_license_type() != DUPX_License_Type::BusinessGold);
$multisite_disabled = false;
