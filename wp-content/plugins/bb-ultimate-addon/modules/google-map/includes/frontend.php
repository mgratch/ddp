...
<div class='uabb-module-content uabb-google-map-wrapper' id="uabb-google-map" <?php echo $style; ?> >
	...
	<div class='uabb-google-map-error' style="line-height: 1.5em;padding: 50px;text-align: center;position: absolute;top: 50%;width: 100%;left: 50%;transform: translate(-50%,-50%);">
		<span style=" line-height: 1.45em;"> <?php _e( 'It seems that you have not yet configured Google Map API key. To display advanced Google map, please set up API key in', 'uabb' ) ?> <a href="<?php echo admin_url( 'options-general.php?page=uabb-builder-settings#uabb' ); ?>" class="uabb-google-map-notice" target="_blank" rel="noopener"><span style="font-weight:bold;"><?php _e( 'General Settings', 'uabb' ); ?></span></a></span>.
	</div>
	<?php } ?>
</div>
