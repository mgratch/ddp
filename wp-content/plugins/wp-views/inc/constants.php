...
define( 'WPV_FILTER_BY_POST_PARENT_LINK', 'http://wp-types.com/documentation/user-guides/displaying-brother-pages/?utm_source=viewsplugin&utm_campaign=views&utm_medium=edit-view-post-parent-filter&utm_term=Learn about displaying brother pages using this filter' );

define('WPV_FILTER_BY_SPECIFIC_TEXT_LINK', 'https://wp-types.com/documentation/user-guides/filtering-views-for-a-specific-text-string-search/?utm_source=viewsplugin&utm_campaign=views&utm_medium=edit-view-search-text-filter&utm_term=Learn about filtering for a specific text string');
