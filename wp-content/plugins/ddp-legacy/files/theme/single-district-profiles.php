<?php
/*
Template Name: district profiles
*/
?>
...
<?php get_header(); ?>
	...
	?>
		 ...
		 <div id="wrapper-interior" class="interior-page live-here archive ">
	 ...
	 <div class="interior-content">
	 	<div class="row main-body"> 
				...
				$wp_query->query('showposts=6&post_type=events'.'&paged='.$paged);
				...
				<div class="row">
				    ...
				    <div class="col-md-9">
				    <p class="date"><?php print get_post_meta($post->ID, 'wpcf-event-when', true); ?></p>
