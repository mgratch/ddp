 ...
 * @since 1.9.1
 */
final class Toolset_Field_Renderer_Preview_Image extends Toolset_Field_Renderer_Preview_Base {
	...
	protected function get_maximum_image_size() {
		return toolset_getarr( $this->args, 'maximum_image_size', self::DEFAULT_MAX_IMAGE_SIZE );
	}
