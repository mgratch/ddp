...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(33)(Function.call, __webpack_require__(52).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__optgroup__ = __webpack_require__(107);
...
var ViewSelect = function (_Component) {
	__WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_inherits___default()(ViewSelect, _Component);

	function ViewSelect() {
		__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_classCallCheck___default()(this, ViewSelect);

		return __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_possibleConstructorReturn___default()(this, (ViewSelect.__proto__ || __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_get_prototype_of___default()(ViewSelect)).apply(this, arguments));
	}

	__WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(ViewSelect, [{
		key: 'render',
		value: function render() {
			var _props = this.props,
			    attributes = _props.attributes,
			    className = _props.className,
			    onChangeView = _props.onChangeView;
			...
			return 'undefined' !== typeof posts && 'undefined' !== typeof taxonomy && 'undefined' !== typeof users && (posts.length > 0 || taxonomy.length > 0 || users.length > 0) ?
			...
			wp.element.createElement(
				...
				posts.length > 0 ? wp.element.createElement(__WEBPACK_IMPORTED_MODULE_5__optgroup__["a" /* default */], {
					attributes: {
						label: __('Post Views'),
						items: posts
					}
				}) : null,
				taxonomy.length > 0 ? wp.element.createElement(__WEBPACK_IMPORTED_MODULE_5__optgroup__["a" /* default */], {
					attributes: {
						label: __('Taxonomy Views'),
						items: taxonomy
					}
				}) : null,
				users.length > 0 ? wp.element.createElement(__WEBPACK_IMPORTED_MODULE_5__optgroup__["a" /* default */], {
					attributes: {
						label: __('User Views'),
						items: users
					}
...
/* harmony default export */ __webpack_exports__["a"] = (ViewSelect);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__icon__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__inspector_inspector__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__inspector_view_select__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__view_preview__ = __webpack_require__(116);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_classnames__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_classnames___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_classnames__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__styles_style_scss__ = __webpack_require__(117);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__styles_style_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__styles_style_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__styles_editor_scss__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__styles_editor_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9__styles_editor_scss__);
...
var settings = {
	...
	edit: function edit(props) {
		var onChangeLimit = function onChangeLimit(value) {
		...
		var onChangeOrderby = function onChangeOrderby(value) {
			props.setAttributes({ orderby: value });
		};

		var onChangeOrder = function onChangeOrder(value) {
			props.setAttributes({ order: value });
		};

		var onChangeSecondaryOrderby = function onChangeSecondaryOrderby(value) {
		...
		var onChangeSecondaryOrder = function onChangeSecondaryOrder(value) {
			props.setAttributes({ secondaryOrder: value });
		};

		var onChangeView = function onChangeView(event) {
			props.setAttributes({ view: event.target.value });
		};

		var onChangeFormDisplay = function onChangeFormDisplay(value) {
			props.setAttributes({ formDisplay: value });
		};

		var onChangeFormOnlyDisplay = function onChangeFormOnlyDisplay(value) {
			props.setAttributes({ formOnlyDisplay: value });
		};

		var onChangeOtherPageID = function onChangeOtherPageID(value) {
			props.setAttributes({ otherPageID: value });
		};

		var onChangeQueryFilters = function onChangeQueryFilters(value, filterType) {
			var newQueryFilters = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_assign___default()({}, props.attributes.queryFilters);
			newQueryFilters[filterType] = value;
			props.setAttributes({ queryFilters: newQueryFilters });
		};

		var onPreviewStateUpdate = function onPreviewStateUpdate(state) {
			props.setAttributes({ hasCustomSearch: state.hasCustomSearch });
			props.setAttributes({ hasSubmit: state.hasSubmit });
			if (__WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_json_stringify___default()(props.attributes.hasExtraAttributes) !== __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_json_stringify___default()(state.hasExtraAttributes)) {
				props.setAttributes({ hasExtraAttributes: state.hasExtraAttributes });
				if ('undefined' !== typeof state.hasExtraAttributes && state.hasExtraAttributes.length <= 0) {
		...
		return [!!(props.focus || props.isSelected) && wp.element.createElement(__WEBPACK_IMPORTED_MODULE_4__inspector_inspector__["a" /* default */], {
			...
			className: __WEBPACK_IMPORTED_MODULE_7_classnames___default()('wp-block-toolset-view-inspector'),
			attributes: {
		...
		}), '' === props.attributes.view ? wp.element.createElement(
			Placeholder,
			{
				key: 'view-block-placeholder',
				className: __WEBPACK_IMPORTED_MODULE_7_classnames___default()('wp-block-toolset-view')
			},
			wp.element.createElement(
				'div',
			...
			wp.element.createElement(__WEBPACK_IMPORTED_MODULE_5__inspector_view_select__["a" /* default */], {
				...
				className: __WEBPACK_IMPORTED_MODULE_7_classnames___default()('blocks-select-control__input'),
				onChangeView: onChangeView
			})
	...
	save: function save(props) {
		var view = props.attributes.view || '',
		...
		if (props.attributes.hasCustomSearch && 'form' === props.attributes.formDisplay) {
			shortcodeStart = '[wpv-form-view';
			if ('samePage' === props.attributes.formOnlyDisplay) {
				target = ' target_id="self"';
			} else if ('otherPage' === props.attributes.formOnlyDisplay && props.attributes.hasSubmit && '' !== props.attributes.otherPageID) {
				target = ' target_id="' + props.attributes.otherPageID + '"';
			}
		}

		if (props.attributes.hasCustomSearch && 'results' === props.attributes.formDisplay) {
			target = '';
			viewDisplay = ' view_display="layout"';
		}

		props.attributes.hasExtraAttributes.forEach(function (item) {
			if (0 < __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_keys___default()(props.attributes.queryFilters).length) {
		...
		return wp.element.createElement(
			RawHTML,
			null,
			shortcodeStart + view + limit + offset + orderby + order + secondaryOrderby + secondaryOrder + target + viewDisplay + queryFilters + shortcodeEnd
		);
	}
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_inherits__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_inherits___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_inherits__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__view_select__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__query_filters__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_interpolate_components__ = __webpack_require__(109);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_interpolate_components___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_interpolate_components__);
	...
	__WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(Inspector, [{
		...
		value: function render() {
			var _props = this.props,
			    ...
			    className = _props.className,
			    onChangeView = _props.onChangeView,
			    onChangeLimit = _props.onChangeLimit,
			    onChangeOffset = _props.onChangeOffset,
			    onChangeOrderby = _props.onChangeOrderby,
			    onChangeOrder = _props.onChangeOrder,
			    onChangeSecondaryOrderby = _props.onChangeSecondaryOrderby,
			    onChangeSecondaryOrder = _props.onChangeSecondaryOrder,
			    onChangeFormDisplay = _props.onChangeFormDisplay,
			    onChangeFormOnlyDisplay = _props.onChangeFormOnlyDisplay,
			    onChangeOtherPageID = _props.onChangeOtherPageID,
			    onChangeQueryFilters = _props.onChangeQueryFilters;
			var view = attributes.view,
			    hasCustomSearch = attributes.hasCustomSearch,
			    hasSubmit = attributes.hasSubmit,
			    hasExtraAttributes = attributes.hasExtraAttributes,
			    limit = attributes.limit,
			    offset = attributes.offset,
			    orderby = attributes.orderby,
			    order = attributes.order,
			    secondaryOrderby = attributes.secondaryOrderby,
			    secondaryOrder = attributes.secondaryOrder,
			    formDisplay = attributes.formDisplay,
			    formOnlyDisplay = attributes.formOnlyDisplay,
			    otherPageID = attributes.otherPageID,
			    queryFilters = attributes.queryFilters;
			...
			var hasSubmitNotice = wp.element.createElement(
				'div',
				{ className: 'wpv-has-submit-notice' },
				wp.element.createElement(
					'p',
					null,
			...
			var resultsNotice = wp.element.createElement(
				'div',
				{ className: 'results-notice' },
				wp.element.createElement(
					'p',
					null,
					__WEBPACK_IMPORTED_MODULE_7_interpolate_components___default()({
						mixedString: sprintf('You are only displaying the %s in this block.', '{{strong}}' + __('search results') + '{{/strong}}') + ' ' + sprintf('A custom search should have the %s and %s.', '{{strong}}' + __('search results') + '{{/strong}}', '{{strong}}' + __('search form') + '{{/strong}}') + ' ' + sprintf('To display the %s you need to:', '{{strong}}' + __('search form') + '{{/strong}}'),
						components: { strong: wp.element.createElement('strong', null) }
					})
				),
				wp.element.createElement(
					'ol',
					...
					wp.element.createElement(
						'li',
						null,
						__('Create a different View block and display this View.')
					),
					wp.element.createElement(
						'li',
						null,
			...
			return wp.element.createElement(
				...
				wp.element.createElement(
					...
					wp.element.createElement(__WEBPACK_IMPORTED_MODULE_5__view_select__["a" /* default */], {
						attributes: {
							posts: posts,
							taxonomy: taxonomy,
							users: users,
					...
					'undefined' !== typeof posts && 'undefined' !== typeof taxonomy && 'undefined' !== typeof users && (posts.length > 0 || taxonomy.length > 0 || users.length > 0) && '' !== view ? [hasCustomSearch ? wp.element.createElement(
						PanelBody,
						{
						...
						wp.element.createElement(
							...
							wp.element.createElement(RadioControl, {
								...
								help: __('The first option will display the full View.') + ' ' + __('The second option will display just the form, you can then select where to display the results.') + ' ' + __('Finally, the third option will display just the results, you need to add the form elsewhere targeting this page.'),
								options: [{ value: 'full', label: __('Both the search form and results') }, { value: 'form', label: __('Only the search form') }, { value: 'results', label: __('Only the search results') }]
							})
						),
						!hasSubmit && 'form' === formDisplay ? wp.element.createElement(
							PanelRow,
							null,
							wp.element.createElement(
								'div',
								null,
								wp.element.createElement(Notice, { status: 'warning',
									content: hasSubmitNotice,
									isDismissible: false
								})
							)
						) : null,
						'form' === formDisplay ? wp.element.createElement(
							PanelRow,
							null,
							wp.element.createElement(RadioControl, {
						...
						'results' === formDisplay ? wp.element.createElement(
							PanelRow,
							null,
							wp.element.createElement(
								'div',
						...
						'form' === formDisplay && 'otherPage' === formOnlyDisplay ? wp.element.createElement(
							PanelRow,
							null,
					...
					) : null, 'undefined' !== typeof hasExtraAttributes && hasExtraAttributes.length > 0 ? wp.element.createElement(
						PanelBody,
						{
							title: __('Query filters'),
							key: 'query-filters-settings-panel'
						},
						wp.element.createElement(__WEBPACK_IMPORTED_MODULE_6__query_filters__["a" /* default */], {
							attributes: {
						...
						wp.element.createElement(
							...
							wp.element.createElement(TextControl, {
								...
								help: __('Change how the results will be ordered.') + ' ' + __('You can sort by a custom field simply using the value field-xxx where xxx is the custom field slug.'),
						...
						wp.element.createElement(
							...
							wp.element.createElement(SelectControl, {
								...
								options: [{ value: '', label: __('Default setting') }, { value: 'asc', label: __('Ascending') }, { value: 'desc', label: __('Descending') }]
							})
						)
					), wp.element.createElement(
						PanelBody,
						...
						wp.element.createElement(
							...
							wp.element.createElement(SelectControl, {
								...
								options: [{ value: '', label: __('No secondary sorting') }, { value: 'post_date', label: __('Post date') }, { value: 'post_title', label: __('Post title') }, { value: 'ID', label: __('ID') }, { value: 'post_author', label: __('Post author') }, { value: 'post_type', label: __('Post type') }]
							})
						),
						wp.element.createElement(
							PanelRow,
...
var OptGroup = function (_Component) {
	__WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_inherits___default()(OptGroup, _Component);

	function OptGroup() {
		__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_classCallCheck___default()(this, OptGroup);

		return __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_possibleConstructorReturn___default()(this, (OptGroup.__proto__ || __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_get_prototype_of___default()(OptGroup)).apply(this, arguments));
	}

	__WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(OptGroup, [{
		key: "render",
		value: function render() {
...
var QueryFilters = function (_Component) {
	__WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_inherits___default()(QueryFilters, _Component);

	function QueryFilters() {
		__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_classCallCheck___default()(this, QueryFilters);

		return __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_possibleConstructorReturn___default()(this, (QueryFilters.__proto__ || __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_get_prototype_of___default()(QueryFilters)).apply(this, arguments));
	}

	__WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(QueryFilters, [{
		key: 'render',
		value: function render() {
			var _props = this.props,
			    attributes = _props.attributes,
			    onChangeQueryFilters = _props.onChangeQueryFilters;
			var hasExtraAttributes = attributes.hasExtraAttributes,
			    queryFilters = attributes.queryFilters;


			var output = hasExtraAttributes.map(function (attribute, index) {
...
/* harmony default export */ __webpack_exports__["a"] = (QueryFilters);
...
var _reactAddonsCreateFragment = __webpack_require__(114);

var _reactAddonsCreateFragment2 = _interopRequireDefault(_reactAddonsCreateFragment);

var _tokenize = __webpack_require__(115);
...
var m=__webpack_require__(96),n=__webpack_require__(97),p=__webpack_require__(54),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_inherits__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_inherits___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_inherits__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_classnames__ = __webpack_require__(23);
...
var ViewPreview = function (_Component) {
	...
	function ViewPreview() {
		__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_classCallCheck___default()(this, ViewPreview);

		// this.resetStateObject = {
		// 	items: [ { ID: 0, post_title: __( 'Loading view' ), className: 'loading' } ],
		// };
		// this.state = this.resetStateObject;
		var _this = __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_possibleConstructorReturn___default()(this, (ViewPreview.__proto__ || __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_get_prototype_of___default()(ViewPreview)).apply(this, arguments));
	...
	__WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(ViewPreview, [{
		key: 'render',
		value: function render() {
			...
			if (error) {
				return wp.element.createElement(
					...
					wp.element.createElement(
						'div',
						{ className: __WEBPACK_IMPORTED_MODULE_5_classnames___default()('wpv-view-info-warning') },
						errorMessage
					)
				);
			}
			...
			return wp.element.createElement(
				'div',
				{ className: this.props.className },
				this.state.items.length > 0 ? [wp.element.createElement(
					'div',
					{ key: 'view-information', className: 'view-information' },
					wp.element.createElement(
						'div',
						{ className: __WEBPACK_IMPORTED_MODULE_5_classnames___default()('view-title') },
						wp.element.createElement(
							'span',
							null,
							__('View') + ': ' + this.state.viewTitle
						)
					),
					wp.element.createElement(
						'div',
						{ key: 'view-purpose', className: __WEBPACK_IMPORTED_MODULE_5_classnames___default()('view-purpose') },
						wp.element.createElement(
							'span',
							null,
							this.state.viewPurpose
						)
					),
					'' !== this.state.style ? wp.element.createElement(
						'div',
						{ key: 'view-style', className: __WEBPACK_IMPORTED_MODULE_5_classnames___default()('view-style') },
						wp.element.createElement(
							'span',
							null,
							this.styles[this.state.style]
						)
					) : null
				), 'bootstrap-grid' !== this.state.style ? this.returnViewItemsList() : this.returnViewItemsBootstrapGrid()] : this.returnEmptyPreview()
			);
		}
	}, {
		key: 'viewExists',
		...
		key: 'returnViewDeleted',
		value: function returnViewDeleted() {
			return wp.element.createElement(
				'div',
				{ className: __WEBPACK_IMPORTED_MODULE_5_classnames___default()('wpv-view-info-warning') },
		...
		key: 'returnEmptyPreview',
		value: function returnEmptyPreview() {
			return wp.element.createElement(
				'div',
				{ key: 'empty-preview', className: __WEBPACK_IMPORTED_MODULE_5_classnames___default()('block-preview-list') },
				wp.element.createElement(
					'div',
					{ className: __WEBPACK_IMPORTED_MODULE_5_classnames___default()('row-fluid') },
					wp.element.createElement(
						'div',
						{ className: __WEBPACK_IMPORTED_MODULE_5_classnames___default()('span-preset12', 'wpv-view-block-preview') },
		...
		key: 'returnViewItemsList',
		value: function returnViewItemsList() {
			return wp.element.createElement(
				'div',
				{ key: 'list-preview', className: __WEBPACK_IMPORTED_MODULE_5_classnames___default()('block-preview-list') },
				this.returnViewListItems()
			);
		}
	}, {
		key: 'returnViewItemsBootstrapGrid',
		value: function returnViewItemsBootstrapGrid() {
			return wp.element.createElement(
				'div',
				{ key: 'grid-preview', className: __WEBPACK_IMPORTED_MODULE_5_classnames___default()('block-preview-list') },
				this.returnViewItemsBootstrapGridItems()
			);
		}
	}, {
		key: 'returnViewItemsBootstrapGridItems',
		value: function returnViewItemsBootstrapGridItems() {
			var _this2 = this;

			var columns = this.state.bootstrapGridColumns,
			    columnWidth = 12 / parseInt(columns),
			    items = this.state.items,
			    itemsPerRow = this.chunkArray(items.slice(), columns),
			    rows = itemsPerRow.map(function (row, index) {
				return wp.element.createElement(
					'div',
					{ key: 'row' + index, className: __WEBPACK_IMPORTED_MODULE_5_classnames___default()('row-fluid') },
					row.map(function (item, index2) {
						return wp.element.createElement(
							'div',
							{ key: 'item' + index2, className: __WEBPACK_IMPORTED_MODULE_5_classnames___default()('span-preset' + columnWidth, 'wpv-view-block-preview') },
							_this2.getItemTitle(item)
						);
					})
				);
			});
		...
		key: 'returnViewListItems',
		value: function returnViewListItems() {
			var _this3 = this;

			if (this.state.hasCustomSearch) {
				var customSearchMessage = [];
				switch (this.props.attributes.formDisplay) {
					case 'form':
						customSearchMessage = [wp.element.createElement(
							'h3',
							{ key: 'form-only-h3' },
							__('Form only')
						), wp.element.createElement(
							'p',
							{ key: 'form-only-p' },
							__('This block will only display the custom search form.')
						)];
						break;
					case 'results':
						customSearchMessage = [wp.element.createElement(
							...
							'p',
							{ key: 'results-only-p' },
							__('This block will only display the custom search results.')
						)];
						break;
					case 'full':
					default:
						customSearchMessage = [wp.element.createElement(
							...
							'p',
							{ key: 'full-view-p' },
							__('This block will display a custom search form and its results.')
						)];
						break;
				}
				return wp.element.createElement(
					...
					wp.element.createElement(
						'div',
						{ className: __WEBPACK_IMPORTED_MODULE_5_classnames___default()('span-preset12', 'wpv-view-block-preview', 'wpv-long-preview') },
						customSearchMessage
					)
				);
			}
			...
			if (this.state.items.length > 3) {
				var items = this.state.items.slice(0, 3);
				output = items.map(function (item, index) {
					return wp.element.createElement(
						'div',
						{ key: 'item' + index, className: __WEBPACK_IMPORTED_MODULE_5_classnames___default()('row-fluid') },
						wp.element.createElement(
							'div',
							{ className: __WEBPACK_IMPORTED_MODULE_5_classnames___default()('span-preset12', 'wpv-view-block-preview') },
							_this3.getItemTitle(item)
						)
					);
				});
				output.push(wp.element.createElement(
					'div',
					{ key: 'more', className: __WEBPACK_IMPORTED_MODULE_5_classnames___default()('row-fluid', 'more') },
					wp.element.createElement(
						'div',
						{ className: __WEBPACK_IMPORTED_MODULE_5_classnames___default()('span-preset12', 'wpv-view-block-preview') },
				...
				output = this.state.items.map(function (item, index) {
					if (item.ID === 0) {
						return wp.element.createElement(
							'div',
							{ key: 'item' + index, className: __WEBPACK_IMPORTED_MODULE_5_classnames___default()('row-fluid', item.className) },
							wp.element.createElement(
								'div',
								{ className: __WEBPACK_IMPORTED_MODULE_5_classnames___default()('span-preset12', 'wpv-view-block-preview') },
		...
		key: 'chunkArray',
		value: function chunkArray(myArray, chunkSize) {
			var results = [];
		...
		key: 'getViewInfo',
		value: function getViewInfo(viewId, limit, offset, orderby, order, secondaryOrderby, secondaryOrder) {
			var _this4 = this;
			...
			window.fetch(window.ajaxurl, {
				...
				if (0 !== response && response.success) {
					var items = response.data.view_output,
					    ...
					    bootstrapGridColumns = null !== response.data.view_meta && 'undefined' !== typeof response.data.view_meta.style && 'bootstrap-grid' === response.data.view_meta.style ? response.data.view_meta.bootstrap_grid_cols : 0,
					...
					newState = {
						...
						style: style,
						bootstrapGridColumns: bootstrapGridColumns,
						hasCustomSearch: hasCustomSearch,
						hasSubmit: hasSubmit,
						hasExtraAttributes: hasExtraAttributes
					};
				} else {
				...
				_this4.props.onPreviewStateUpdate(newState);
...
/* harmony default export */ __webpack_exports__["a"] = (ViewPreview);
...
/***/ })
/******/ ]);
//# sourceMappingURL=view.block.editor.js.map